...
class RealESRGANer():
    ...
    def __init__(self,
        ...
        # ✅ แก้ตรงนี้ให้ยืดหยุ่นกับทุกประเภท model
        loadnet = torch.load(model_path, map_location=torch.device('cpu'))

        # ✅ ตรวจสอบ key ที่ใช้จริง
        if isinstance(loadnet, dict):
            ...
            # else: ใช้ทั้ง dict ตรง ๆ
        model.load_state_dict(loadnet, strict=False)  # ✅ ใช้ strict=False เพื่อข้าม key ที่ไม่ตรง
